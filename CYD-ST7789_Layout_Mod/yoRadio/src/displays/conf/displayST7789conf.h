...
const ScrollConfig weatherConf    PROGMEM = {{ TFT_FRAMEWDT, 74, 2, WA_LEFT }, 300, false, MAX_WIDTH, 0, 4, 40 };	// Weather (погода)
...
const VUBandsConfig bandsConf     PROGMEM = { (MAX_WIDTH-TFT_FRAMEWDT*3)/2, 20, TFT_FRAMEWDT, 1, 10, 3 };	//Boombox
