...
const ScrollConfig metaConf    PROGMEM = {{ TFT_FRAMEWDT, TFT_FRAMEWDT+4, 3, WA_CENTER }, 140, false, MAX_WIDTH, 5000, 3, 30 };
const ScrollConfig title1Conf     PROGMEM = {{ TFT_FRAMEWDT, 40, 2, WA_LEFT }, 140, false, MAX_WIDTH, 5000, 2, 30 };
const ScrollConfig title2Conf     PROGMEM = {{ TFT_FRAMEWDT, 60, 2, WA_LEFT }, 140, false, MAX_WIDTH, 5000, 2, 30 };
const ScrollConfig playlistConf  PROGMEM = {{ TFT_FRAMEWDT, 112, 2, WA_LEFT }, 140, true, MAX_WIDTH, 1000, 2, 30 };
const ScrollConfig apTitleConf  PROGMEM = {{ TFT_FRAMEWDT, TFT_FRAMEWDT, 3, WA_CENTER }, 140, false, MAX_WIDTH, 0, 2, 20 };
const ScrollConfig apSettConf   PROGMEM = {{ TFT_FRAMEWDT, 240-24, 2, WA_LEFT }, 140, false, MAX_WIDTH, 0, 2, 30 };
const ScrollConfig weatherConf  PROGMEM = {{ 0, 74, 2, WA_LEFT }, 300, false, DSP_WIDTH, 0, 2, 40 };	// Weather (погода)
...
const VUBandsConfig bandsConf     PROGMEM = { (MAX_WIDTH-TFT_FRAMEWDT*3)/2, 20, TFT_FRAMEWDT, 2, 10, 3 };	//Boombox
