...
#if EXT_WEATHER
const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 Feels like: %.1f\011C \007 Pressure: %d Hg \007 Humidity: %s%% \007 Wind: %.1f m/s [%s]"; // мм
#else
const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 Pressure: %d Hg \007 Humidity: %s%%"; //%d mm
#endif
...
//const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 feels like: %.1f\011C \007 pressure: %d \007 humidity: %s%% \007 wind: %.1f m/s [%s]";
//#else
//const char       weatherFmt[]    PROGMEM = "%s, %.1f\011C \007 pressure: %d \007 humidity: %s%%";
//#endif
//const char     weatherUnits[]    PROGMEM = "metric";   /* standard, metric, imperial */
//const char      weatherLang[]    PROGMEM = "en";       /* https://openweathermap.org/current#multi *//
