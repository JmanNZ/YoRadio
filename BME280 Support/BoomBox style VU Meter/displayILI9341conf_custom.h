...
const ScrollConfig weatherConf    PROGMEM = {{ 8, 87, 2, WA_LEFT }, 140, false, MAX_WIDTH, 0, 4, 70 };  // was 0, 4, 30
...
const WidgetConfig tempConf       PROGMEM = { 30, DSP_HEIGHT-58, 2, WA_LEFT }; // Addded by Jman
...
const WidgetConfig clockConf      PROGMEM = { 46, 176, 52, WA_CENTER };  /* 52 is a fixed font size. do not change */
const WidgetConfig vuConf         PROGMEM = { 0, 200, 1, WA_CENTER };
...
const VUBandsConfig bandsConf     PROGMEM = { 150, 6, 2, 2, 6, 2 };
...
const MoveConfig   weatherMoveVU  PROGMEM = { 8, 97, MAX_WIDTH }; //{ 70, 97, 250 };
